 ...
 */
public class NewtEventConverter
{
	...
	/**
	 * Interface which all AWT events created by the {@link NewtEventConverter}
	 * implement. Provides access to the original NEWT event from which the AWT
	 * event was created.
	 */
