...
* {@link WorldWindowNewtDrawable} interface.
* <p/>
* Most of this implementation is copied from the WorldWindowGLCanvas source.
*
* @author Michael de Hoog (michael.dehoog@ga.gov.au)
*/
public class GLCanvas extends NewtCanvasAWT implements WorldWindow, PropertyChangeListener
{
/**
...
protected final WorldWindowNewtDrawable wwd; // WorldWindow interface delegates to wwd
...
{
this.wwd =
((WorldWindowNewtDrawable) WorldWind.createConfigurationComponent(AVKey.WORLD_WINDOW_CLASS_NAME));
...
* GraphicsDevice)
*/
public GLCanvas(WorldWindow shareWith)
{
super(GLWindow.create(getCaps()));
this.window = (GLWindow) getNEWTChild();
if (shareWith != null)
